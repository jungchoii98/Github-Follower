            ...
            case .success(let user):
                ...
                PersistenceManager.update(with: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Successfully added to favorites", message: "You have successfully added this user to your favorites list!", buttonTitle: "Hooray!")
                        return
                    }
